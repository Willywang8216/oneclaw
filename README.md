...
| 💬 **多渠道集成** | Telegram / Discord / 飞书 / 企业微信 / 钉钉 / QQ Bot / 微信，一键连接团队 IM |
...
**Q: 支持哪些聊天渠道？**
A: Telegram、Discord、飞书、企业微信、钉钉、QQ Bot、微信。在设置 → 渠道 中扫码绑定/配置即可。
...
| 💬 **Multi-Channel** | Telegram / Discord / Feishu / WeCom / DingTalk / QQ Bot / WeChat — connect your team IM in one click |
...
A: Telegram, Discord, Feishu (Lark), WeCom, DingTalk, QQ Bot, and WeChat. Go to Settings → Channels to connect/configure.
